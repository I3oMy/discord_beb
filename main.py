...
async def on_message(message):
    ...
    # ฟีเจอร์: ถามว่า "กินอะไรดี"
    if "กินอะไรดี" in message.content:
        menu_list = [
        ...
        await message.channel.send(f"ลองกิน **{menu}** ดูไหม? 🍽️")

    # สำคัญ! เพื่อให้คำสั่งอื่น ๆ ใช้งานได้ (เช่น commands หรือ slash commands)
